...
const AlumniProfile: React.FC = () => {
  ...
  const handleMessage = () => {
    alert(`Message sent to ${alumni.name}!`);
  };

  const handleMentorship = () => {
    alert(`Mentorship request sent to ${alumni.name}!`);
  };
          ...
          <CardContent className="p-0">
            ...
            <div className="px-8 pb-8">
              ...
              <div className="flex space-x-4 mb-6">
                {alumni.linkedin && (
                  <a href={`https://${alumni.linkedin}`} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                    <Linkedin className="h-6 w-6" />
                  </a>
                )}
                {alumni.github && (
                  <a href={`https://${alumni.github}`} target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-gray-900">
                    <Github className="h-6 w-6" />
                  </a>
                )}
                {alumni.twitter && (
                  <a href={`https://${alumni.twitter}`} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-600">
